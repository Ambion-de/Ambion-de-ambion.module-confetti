...
(function () { function n(n, t) { return Math.random() * (t - n) + n } document.head.insertAdjacentHTML("beforeend", "<style>\n    body {\n        background-color: antiquewhite;\n        background-image: url('images/bg.png');\n        font-family: Arial, sans-serif;\n    }\n\n\n    #stimmt-container-backdrop {\n        position: absolute;\n        top: 0;\n        left: 0;\n        width: 100%;\n        height: 100%;\n        background-color: rgba(0, 0, 0, 0.5);\n        opacity: 0;\n        transition: 1s opacity;\n    }\n\n    #stimmt-container-backdrop.show {\n        opacity: 1;\n    }\n\n    #stimmt-container-modal {\n        display: none;\n        position: fixed;\n        top: 0;\n        left: 0;\n        width: 100%;\n        height: 100%;\n        z-index: 111119999;\n        display: flex;\n        justify-content: center;\n        align-items: center;\n        transition: 1s opacity;\n        opacity: 0;\n        visibility: hidden;\n    }\n\n    #stimmt-container-modal.show {\n        opacity: 1;\n        visibility: visible;\n    }\n\n    #stimmt-container-modal .modal {\n        position: absolute;\n        background-color: #ff2ad1;\n        padding: 20px;\n        border-radius: 5px;\n        box-shadow: 0 0 10px rgba(0, 0, 0, 0.5);\n        text-align: center;\n        width: 300px;\n        text-transform: uppercase;\n        padding-bottom: 30px;\n    }\n\n    #stimmt-container-modal .modal h2 {\n        margin-bottom: 40px;\n    }\n\n    #stimmt-container-modal .modal .url {\n        margin-bottom: 40px;\n        padding: 16px 24px;\n        background-color: #67ff64;\n        color: #000000;\n        border: none;\n        font-size: 16px;\n        cursor: pointer;\n        transition: 0.5s background-color;\n        text-decoration: none;\n        cursor: pointer;\n    }\n\n    #stimmt-container-modal .modal .url:hover {\n        background-color: #996fff;\n    }\n\n    #stimmt-container-modal .modal .close {\n        background: none;\n        border: none;\n        font-size: 20px;\n        position: absolute;\n        top: 10px;\n        right: 10px;\n        cursor: pointer;\n    }\n</style>"); const t = (n, t, e) => { var i = ""; if (e) { var o = new Date; o.setTime(o.getTime() + 24 * e * 60 * 60 * 1e3), i = "; expires=" + o.toUTCString() } document.cookie = n + "=" + (t || "") + i + "; path=/" }, e = n => { const t = new RegExp(`(^| )${n}=([^;]+)`), e = document.cookie.match(t); if (e) return e[2] }; if (e("stimmt-fuer")) return; const i = document.createElement("div"); i.id = "stimmt-container-backdrop", setTimeout(() => { i.classList.add("show") }, 500), document.body.appendChild(i); const o = document.createElement("div"); o.id = "stimmt-container-modal", setTimeout(() => { o.classList.add("show") }, 500); const a = document.createElement("div"); a.classList.add("modal"); const s = document.createElement("button"); s.id = "modal-close", s.classList.add("close"), s.textContent = "X"; const r = document.createElement("div"); r.classList.add("modal-header"); const d = document.createElement("h2"); d.textContent = "Stimmt für Vielfalt, Demokratie und Toleranz heißt wählt Vielfalt, Demokratie und Toleranz!"; const c = document.createElement("a"); c.classList.add("url"), c.href = "https://www.stimmt-fuer.de", c.target = "_blank", c.textContent = "www.stimmt-fuer.de", r.appendChild(d), r.appendChild(c), a.appendChild(s), a.appendChild(r), o.appendChild(a), document.body.appendChild(o); const m = 12e4, l = Date.now() + m; var h = [{ src: "images/01.png", width: 32, height: 32 }, { src: "images/02.png", width: 32, height: 32 }, { src: "images/03.png", width: 32, height: 32 }, { src: "images/04.png", width: 32, height: 32 }, { src: "images/05.png", width: 32, height: 32 }, { src: "images/06.png", width: 32, height: 32 }, { src: "images/07.png", width: 32, height: 32 }, { src: "images/08.png", width: 32, height: 32 }, { src: "images/09.png", width: 32, height: 32 }, { src: "images/10.png", width: 32, height: 32 }, { src: "images/11.png", width: 32, height: 32 }, { src: "images/12.png", width: 32, height: 32 }, { src: "images/13.png", width: 32, height: 32 }, { src: "images/14.png", width: 32, height: 32 }, { src: "images/15.png", width: 32, height: 32 }, { src: "images/16.png", width: 32, height: 32 }]; const g = setInterval(() => { const t = l - Date.now(); if (t <= 0) return closeAll(), clearInterval(g); confetti({ ticks: 400, gravity: 2, particleCount: 100, angle: 0, spread: 360, scalar: n(4, 4), origin: { x: .5, y: .5 }, shapes: ["image"], shapeOptions: { image: h }, flat: !1, drift: 4, startVelocity: 50, decay: .9, zIndex: 9999999 }) }, 1200); s.addEventListener("click", () => { closeAll() }), closeAll = (() => { i.classList.remove("show"), o.classList.remove("show"), setTimeout(() => { a.remove(), i.remove() }, 1e3), clearInterval(g), t("stimmt-fuer", "true", 7) }) })();